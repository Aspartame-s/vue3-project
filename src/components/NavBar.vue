<template>
  <nav class="navbar navnar-dark bg-primary justify-content-between mb-4 px-4" data-bs-theme="dark">
    <router-link to="/" class="navbar-brand" href="#">鸡汤专栏</router-link>
...
import DropdowmItem from "./DropdowmItem.vue";
